        ...
        <>
          <div className='mb-4 flex flex-col sm:flex-row'>
            <div className='w-full sm:w-1/3 sm:mr-2 mb-4 sm:mb-0'>
              <DashboardMetric
                title='Sales Volume'
                value={formatCurrency(data.dashboardData.salesVolume)}
                icon={faChartArea}
              />
            </div>
            ...
            <div className='w-full sm:w-1/3 sm:ml-2 mb-4 sm:mb-0'>
              <DashboardMetric
                title='Refunds'
                value={formatCurrency(data.dashboardData.refunds)}
                icon={faDollarSign}
              />
            </div>
          </div>
          <div className='w-full mt-4'>
            <Card>
              {data.dashboardData && (
                <DashboardChart salesData={data.dashboardData.graphData} />
              )}
            </Card>
          </div>
        </>
