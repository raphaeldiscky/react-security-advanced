...
const Settings = () => {
  ...
  const [updateUserBio, { error, data: mutationData }] = useMutation(
    UPDATE_USER_BIO
  )
  ...
  return (
    <>
      ...
      <Card>
        ...
        {mutationData && (
          <FormSuccess text={mutationData.updateUserBio.message} />
        )}
        ...
        {data && (
          <Formik
            ...
            onSubmit={(values) => updateUserBio({ variables: { ...values } })}
