...
const Inventory = () => {
  ...
  const [addInventoryItem, { data: addItemData }] = useMutation(
    ADD_INVENTORY_ITEM,
    {
  ...
  return (
    <>
      ...
      {addItemData && (
        <FormSuccess text={addItemData.addInventoryItem.message} />
      )}
      ...
      {data && data.inventoryItems.length
        ? data.inventoryItems.map((item) => (
            <InventoryItemContainer key={item._id}>
              <InventoryItem item={item} onDelete={deleteInventoryItem} />
